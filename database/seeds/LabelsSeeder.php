...
class LabelsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('labels')->insert([
            ...
            'value'=> 'We at "EduPartner group" have devised a special model to audit schools and determine their strengths and weaknesses. Our audit model consists of 8 different capabilities.'
        ]);
        DB::table('labels')->insert([
